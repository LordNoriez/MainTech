		...
		<div class="row">
			...
			<div class=" col-md-8" >
				...
				<form:form method="PUT" modelAttribute="categoria" action="${variableAdd}">
					...
					<label>Nombre:</label>
					<form:input type="text" class="form-control" path="NombreCategoria" value = "${categoria.nombreCategoria}"/>
					<br>
				
					<label>Descripción:</label>
					<form:input type="text" class="form-control" path="DescripcionCategoria" value = "${categoria.descripcionCategoria}"/>
					<br>				
