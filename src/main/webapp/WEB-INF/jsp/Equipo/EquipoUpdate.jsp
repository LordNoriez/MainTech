...
<!-- 		  <a href="/categoria">Ver</a> -->
    ...
    <!--<div class="container" style="margin-top: 50px;">-->
		...
		<div class="row">
			...
			<div class=" col-md-8" >
				<spring:url value="/equipoUpdate/${equipo.idEquipo}" var="variableAdd" />
			
				<form:form method="PUT" modelAttribute="equipo" action="${variableAdd}">
			
					<label>Nombre:</label>
					<form:input type="text" class="form-control" path="NombreEquipo" value = "${equipo.nombreEquipo}"/>
					<br>
