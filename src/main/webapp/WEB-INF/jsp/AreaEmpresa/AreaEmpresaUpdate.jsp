...
<head>
    ...
    <title>Editar Área de la Empresa</title>
			...
			<div class=" col-md-12">		
				<div class="header clearfix">
			        <div class=" col-md-6">
				        ...
				        <h4 class="text-muted">Editar Área de la Empresa</h4>
			        </div>
			    </div>
			</div>
		</div>
		<div class="row">
			...
			<div class=" col-md-8" >
				...
				<form:form method="PUT" modelAttribute="ModelAreaEmpresa" action="${variableAdd}">
					...
					<label>Nombre:</label>
					<form:input type="text" class="form-control" path="NombreAreaEmpresa" value = "${ModelAreaEmpresa.nombreAreaEmpresa}"/>
					<br>
