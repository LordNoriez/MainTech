...
<!-- 		  <a href="/categoria">Ver Categorías</a>-->
    ...
    <!--<div class="container" style="margin-top: 50px;">-->
		...
		<div class="row">
			...
			<div class=" col-md-8"  >
				<spring:url value="/updateActividad/${VarActividad.idActividad}" var="variableAdd" />
			
				<form:form method="PUT" modelAttribute="VarActividad" action="${variableAdd}">
				
					<label>Nombre: </label>
					<form:input type="text" path="NombreActividad" class="form-control" value = "${VarActividad.nombreActividad}"/>					
					<br>

					<label>Costo ($): </label>
					<form:input type="text" path="CostoActividad" class="form-control" value = "${VarActividad.costoActividad}"/>					
					<br>

					<label>Descripción: </label>
					<form:input type="text" path="DescripcionActividad" class="form-control" value = "${VarActividad.descripcionActividad}"/>					
					<br>
