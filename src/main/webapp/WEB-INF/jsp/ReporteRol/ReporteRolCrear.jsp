...
<head>
    ...
    <title>Vincular Reporte a Rol</title>
...
<!-- 		  <a href="/actividad">Ver</a> -->
    ...
    <!--<div class="container" style="margin-top: 50px;">-->
			...
			<div class=" col-md-12">		
				<div class="header clearfix">
			        <div class=" col-md-6">
				        ...
				        <h4 class="text-muted">Vincular Reporte a Rol</h4>
			        </div>
			    </div>
			</div>
		</div>
		<div class="row">
			...
			<div class=" col-md-8"  >
				<spring:url value="/addReporteRol" var="variableAdd" />
			
				<form:form method="post" modelAttribute="crearModelReporteRol" action="${variableAdd}">
					<label>Reportes: </label>						        
					<form:select class="form-control" path="reporte">
						<form:options items="${reportes}" itemLabel="NombreReporte" itemValue="idReporte" />
					</form:select>
					<br>
