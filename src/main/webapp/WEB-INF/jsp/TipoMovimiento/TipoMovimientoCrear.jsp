...
<head>
    ...
    <title>Crear Tipo de Mantenimiento</title>
...
<body ng-app="MainTech" ng-controller="AppCtrl" ng-cloak>
    ...
    <!--<div class="container" style="margin-top: 50px;">-->
			...
			<div class=" col-md-12">		
				<div class="header clearfix">
			        <div class=" col-md-6">
				        ...
				        <h4 class="text-muted">Crear Tipo de Movimiento</h4>
			        </div>
			    </div>
			</div>
		</div>
		<div class="row">
			...
			<div class=" col-md-8"  >
				<spring:url value="/addTipoMovimiento" var="variableAdd" />
			
				<form:form method="POST" modelAttribute="crearModelTipoMovimiento" action="${variableAdd}">	
				
					<label>Nombre: </label>
					<form:input path="NombreTipoMantenimiento" class="form-control" type="text" /> <!-- bind to user.name-->
