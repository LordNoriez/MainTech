<head>
    <title>Crear Equipo de Protección</title>
...
<body ng-app="MainTech" ng-controller="AppCtrl" ng-cloak>
		...
		<div class=" col-md-12">		
			<div class="header clearfix">
		        <div class=" col-md-6">
		        <h4 class="text-muted">Crear Equipo de Protección</h4>
		        </div>
		    </div>
		</div>
...
<!-- 		  <a href="/actividad">Ver</a> -->
    ...
    <!--<div class="container" style="margin-top: 50px;">-->
		<div class="row">
			...
			<div class=" col-md-8"  >
				<spring:url value="/addEpp" var="variableAdd" />
			
				<form:form method="post" modelAttribute="crearModelEpp" action="${variableAdd}">
					<label>Nombre: </label>
					<form:input path="nombreEpp" class="form-control" type="text" /> 
					<form:errors path="nombreEpp" />
					<br>
